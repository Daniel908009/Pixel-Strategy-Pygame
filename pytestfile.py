...
# this function decides which tiles are of interest to other functions
# its now fully operational and ready to be implemented in the functions file
def optimalization():
...
players.append({"coordinates": [(3,0), (3,2)], "num_of_tiles": 2})
